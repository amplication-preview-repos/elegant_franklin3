...
@InputType()
class LeaderboardCreateNestedManyWithoutPlayersInput {
...
export { LeaderboardCreateNestedManyWithoutPlayersInput as LeaderboardCreateNestedManyWithoutPlayersInput };
