...
import { ANDY_TITLE_FIELD } from "./AndyTitle";
import { RACE_TITLE_FIELD } from "../race/RaceTitle";

export const AndyShow = (props: ShowProps): React.ReactElement => {
  return (
    <Show {...props}>
      <SimpleShowLayout>
        ...
        <ReferenceManyField reference="Race" target="playerId" label="Races">
          <Datagrid rowClick="show">
            <DateField source="createdAt" label="Created At" />
        ...
        <ReferenceManyField reference="Score" target="playerId" label="Scores">
          <Datagrid rowClick="show">
            <DateField source="createdAt" label="Created At" />
            <TextField label="ID" source="id" />
            <ReferenceField label="Player" source="andy.id" reference="Andy">
