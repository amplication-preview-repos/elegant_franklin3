...
@InputType()
class LeaderboardCreateNestedManyWithoutAndiesInput {
...
export { LeaderboardCreateNestedManyWithoutAndiesInput as LeaderboardCreateNestedManyWithoutAndiesInput };
